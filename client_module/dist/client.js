...
class IdentityClient {
     ...
     */
    getUrl() {
        return `${this.options.identityUrl}/api/auth/authorize?client_id=${this.options.clientId}&redirect_uri=${this.options.redirectUri}&scope=${this.options.scopes.join("%20")}`;
    }
    /**
    ...
    getAccessToken(code) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield axios_1.default.post(`${this.options.identityUrl}/api/auth/token`, {
    ...
    getUserInfo(accessToken) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield axios_1.default.get(`${this.options.identityUrl}/api/auth/userinfo`, {
                headers: {
...
exports.default = IdentityClient;
